...
function Resume() {
    ...
    <div className="resumeSection">
        ...
        <div className="PDFoffer"> for a PDF Copy of my resume Please click<a target="blank" href="https://drive.google.com/file/d/1fdtvhHIFh6q8DtoQK0dYcibIDW2CuSZB/view?usp=sharing">Here</a></div>
