...
function showDiv(){
    ...
    return(
        ...
        <Card className=" cardExperience bg-dark text-light">
            ...
            I am a very quick study, and have heavy experience using the MERN stack. 
            <div className="break"></div>I recently attended the University of Utah and received a certificate in full stack development. 
            ...
            <Card.Header className="projectTitleExperience2Mobile">Some experience I bring outside of Web Development</Card.Header>
            <Card.Body className="cardflex">
            <Card.Text className="aboutMeCardText">
